...
import { View, Text, TextInput, Image, ScrollView, TouchableOpacity, Alert, StyleSheet } from 'react-native';
...
const CSignup = ({ navigation }) => {
  ...
  const handleDone = async () => {
    if (validateInputs()) {
      try {
        await AsyncStorage.setItem("hname", `${firstname} ${lastname}`);
        await AsyncStorage.setItem("hemail", email);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        {facePicture ? <Image source={{ uri: facePicture }} style={styles.imagePreview} /> : null}
