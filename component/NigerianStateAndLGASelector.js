...
const NigerianStateAndLGASelector = ({ state, lga, onStateChange, onLGAChange }) => {
  const statesWithLGAs = {
    ...
    AkwaIbom: ["Abak", "Eastern Obolo", "Eket", "Esit Eket", "Essien Udim", "Etim Ekpo", "Etinan", "Ibeno", "Ibesikpo Asutan", "Ibiono-Ibom", "Ikot Abasi", "Ikot Ekpene", "Ini", "Itu", "Mbo", "Mkpat-Enin", "Nsit-Atai", "Nsit-Ibom", "Nsit-Ubium", "Obot Akara", "Okobo", "Onna", "Oron", "Oruk Anam", "Udung-Uko", "Ukanafun", "Uruan", "Urue-Offong/Oruko", "Uyo"],
      ...
      {selectedState && selectedLGA ? (
        <View style={styles.result}>
          <Text style={styles.resultText}>
            <Text style={styles.bold}>Selected State:</Text> {selectedState}
          </Text>
          <Text style={styles.resultText}>
            <Text style={styles.bold}>Selected LGA:</Text> {selectedLGA}
          </Text>
        </View>
      ) : null}
    </View>
...
export default NigerianStateAndLGASelector;
