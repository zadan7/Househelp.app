  ...
  return (
    <>
      ...
      <Animated.View style={[styles.menu, { left: menuAnimation }]}> 
        ...
        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('cashboard')}>
          <Ionicons name="home" size={20} color="white" style={styles.icon} />
          <Text style={styles.menuText}>Partime Requests day</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Profile')}>
          <Ionicons name="person" size={20} color="white" style={styles.icon} />
          <Text style={styles.menuText}>Partime request Weekly</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Crequest')}>
          ...
          <Text style={styles.menuText}>Fulltime  Request monthly</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Settings')}>
          <Ionicons name="settings" size={20} color="white" style={styles.icon} />
          <Text style={styles.menuText}>Fulltime live out monthly</Text>
        </TouchableOpacity>

        
        <TouchableOpacity style={[styles.menuItem, styles.logout]} onPress={() => navigation.navigate('Balances')}>
          <Ionicons name="history" size={20} color="white" style={styles.icon} />
